...
<div class="page-content clearfix">
    ...
    <div class="search_style">
     	<form action="/pk/qualityList" method="post">
      <ul class="search_content clearfix">
       <li><label class="l_f">供应商名称</label><input name="search" type="text"  class="text_add" placeholder="供应商名称"  style=" width:400px"/></li>
	...
	<tbody>
		...
		<tr>
         ...
         <!--  <td>{{$user->business_license}}</td>
          ...
          <td>{{$user->bond}}</td> -->
          <td class="td-manage">
          <a title="实际厂能" onclick="member_edit('{{$user->supplier_id}}')" href="javascript:;"  class="btn btn-xs  btn-info" ><i class="icon-edit bigger-120">实际厂能</i></a> 
          </td>
		</tr>
		@endforeach
      </tbody>
...
<div class="add_menber" id="add_menber_style" style="display:none">
 ...
 <div class="add_menber2" id="add_menber_style2" style="display:none">
      <table class="table table-bordered">
          <tbody>
          <tr><td class="name">工厂名称</td><td class="munber"><span class="add_name"><input value="" name="工厂名称" type="text"  class="edit_factory_name" /></span></td></tr>
          <tr><td class="name">工厂地址</td><td class="munber"><span class="add_name"><input value="" name="工厂地址" type="text"  class="edit_factory_address" id="edit_staff_phone"/></span></td></tr>
          <tr><td class="name">原日厂能</td><td class="munber"><span class="add_name"><input value="" name="原日厂能" type="text"  class="edit_day_dev_num" id="edit_company_name"/></span></td></tr>
          <tr><td class="name">实际厂能</td><td class="munber"><span class="add_name"><input value="" name="实际厂能" type="text"  class="edit_actual_energy" id="edit_company_address" /></span></td></tr>
          </tbody>
         </table>
 </div>
...
function member_edit(id){
	var res = ajax_req('/supplier/getSingleList',{'supplier_id':id},"get");
  if(res.status != 200){
  ...
  var info = res.data;
  dd(info);
  $(".edit_factory_name").val(info.factory_name);
  $(".edit_factory_address").val(info.factory_address);
  $(".edit_day_dev_num").val(info.day_dev_num);
  $(".edit_actual_energy").val(info.actual_energy);

  $(".edit_factory_name").attr("disabled",true);
  $(".edit_factory_address").attr("disabled",true);
  $(".edit_day_dev_num").attr("disabled",true);


  layer.open({type: 1,title: '实际厂能信息',
    maxmin: false, 
    ...
    yes:function(index,layero){ 
     ...
     var str="";
        var arr = {};
        arr['supplier_id'] = id;
        arr['day_dev_num'] = $(".edit_day_dev_num").val();
        arr['actual_energy'] = $(".edit_actual_energy").val();
        // 调用函数
        var res = ajax_req('/pk/supplierPKEdit',arr);
        if(res.status == 200){
