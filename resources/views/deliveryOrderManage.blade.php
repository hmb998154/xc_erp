           ...
           <form action="/order/orderList" method="get">
                    <div class="search_style">
                        <ul class="search_content clearfix">
                            <li>
                                <input name="order_sn" type="text" class="text_add" placeholder="送货单号" style=" width:250px" />
                            </li>
                            <li>
                                <input name="order_plan_sn" type="text" class="text_add" placeholder="供应商名称" style=" width:250px" />
                            </li>
                            <li>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    <thead>
                        <tr>
                            ...
                            <th width="100px">异商品名称</th>
                            <th width="100px">商品数量</th>
                            <th width="100px">是否入库</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="作废" href="javascript:;" onclick="Order_form_del(this,'1')" class="btn btn-xs btn-info order_detailed">
                                    <i class="fa fa-trash  bigger-120">补单</i>
                                </a>
                            </td>
                        </tr>
                    </tbody>
