...
<div class="page-content clearfix">
    ...
    <div class="search_style">
     	<form action="/pro/cateList" method="get">
      <ul class="search_content clearfix">
       <li><label class="l_f">类目名称</label><input name="search" type="text"  class="text_add" placeholder="输入类目名称"  style=" width:400px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加类目</a>
	...
	<tbody>
		...
		<tr>
          ...
          <td title="{{$menu->cate_id}}" class="staff_id">{{$menu->cate_id}}</td>
          ...
          <a title="编辑" onclick="member_edit('{{$menu->cate_id}}')" href="javascript:;"  class="btn btn-xs  btn-info" ><i class="icon-edit bigger-120"></i></a> 
          <a title="删除" href="javascript:;"  onclick="member_del(this,'{{$menu->cate_id}}')" class="btn btn-xs  btn-danger" ><i class="icon-trash  bigger-120"></i></a>
          </td>
		</tr>
		@endforeach
      </tbody>
...
<div class="add_menber" id="add_menber_style" style="display:none">
     ...
     <tbody>
     <tr>
      <td class="name">类目名称</td>
      <td class="munber"><span class="add_name"><input value="" name="菜单名" id="cate_name_add" type="text"  class="text_add staff_name"/></span></td>
    </tr>
     </tbody>
    </table>
 </div>
...
<!-- 编辑 -->
 <div class="add_menber2" id="add_menber_style2" style="display:none">
 	<table class="table table-bordered">
       <tbody>
       <tr><td class="name">类目名称</td><td class="munber"><span class="add_name"><input value="" name="类目名称" type="text"  id="edit_cate_name" class="text_add"/></span></td></tr>
		...
		yes:function(index,layero){	
		 ...
		 var str="";
		  ...
		  if(num>0){  return false;}	 	
        	...
        	var arr = {};
        	arr['cate_name'] = $("#cate_name_add").val();
          var info = ajax_req('/pro/cateAdd',arr,"post","false","no");
        	if(info.status == 200){
		     	  layer.close(index);	
...
function member_edit(id){
	var res = ajax_req('/pro/getSingleCate',{'cate_id':id},"get");
  if(res.status != 200){
    layer_info(res.msg,2);exit;
  }
  var info = res.data;
  $("#edit_cate_name").val(info.cate_name);
  ...
  yes:function(index,layero){ 
      ...
      arr['cate_id'] = id;
      dd(id);
      arr['cate_name'] = $("#edit_cate_name").val();
    
      var res = ajax_req('/pro/cateEdit',arr);
      if(res.status == 200){
...
function member_del(obj,id){
	layer.confirm('删除无法恢复，确认要删除吗？',{icon: 2, title:'提示'},function(index){
		var res = ajax_req('/pro/cateDel',{'cate_id':id},"get");
		if(res.status == 200){
