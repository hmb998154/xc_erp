...
<div class="page-content clearfix">
 <div class="sort_adsadd_style">
  <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()"  id="ads_add" title="添加品牌" class="btn btn-warning Order_form"><i class="fa fa-plus"></i> 商户入驻1</a>
 ...
 <!--列表样式-->
	...
	<tbody>
      <tr>
       ...
       <td><span class="ad_img"><a href="products/ad.jpg" data-rel="colorbox" data-title="厂商图"><img src="products/ad.jpg"  width="100%" height="100%"/></a></span></td>      
       <td>1890x1080</td>
       <td><a href="#" target="_blank">http://xxxxx/1.html</a></td>
       <td>2016-6-29 12:34</td>
       <td class="td-status"><span class="label label-success radius">待入駐</span></td>
      <td class="td-manage">
      ...
      <tr>
       ...
       <td><span class="ad_img"><a href="products/ad1.jpg" data-rel="colorbox" data-title="厂商图"><img src="products/ad1.jpg"  width="100%" height="100%"/></a></span></td>      
       <td>1890x1080</td>
       <td><a href="#" target="_blank">http://xxxxx/1.html</a></td>
       <td>2016-6-29 12:34</td>
       <td class="td-status"><span class="label label-success radius">待入駐</span></td>
      <td class="td-manage">
       ...
       <td>XXXX厂商</td>
        <td><input name="" type="text"  style=" width:50px" placeholder="2"/></td>
       <td><span class="ad_img"><a href="products/p_42.jpg" data-rel="colorbox" data-title="厂商图"><img src="products/p_42.jpg"  width="100%" height="100%"/></a></span></td>      
       <td>1890x1080</td>
       <td><a href="#" target="_blank">http://xxxxx/1.html</a></td>
       <td>2016-6-29 12:34</td>
       <td class="td-status"><span class="label label-success radius">待入駐</span></td>
...
<div id="add_ads_style"  style="display:none">
 ...
 <ul>
  ...
  <select class="form-control" id="form-field-select-1">
    ...
    <option value="AL">首页大XXXX厂商</option>
    <option value="AK">首页小XXXX厂商</option>
    <option value="AZ">单厂商图</option>
    <option value="AR">其他厂商</option>
    <option value="CA">板块栏目厂商</option>
  </select></span>
  </li>
